...
<x-student-layout>
    ...
    <div class="space-y-6">
        ...
        <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm rounded-lg">
            <div class="p-6">
                <h3 class="text-lg font-medium text-gray-900 dark:text-gray-100 mb-4">Kuis Aktif</h3>
                            ...
                            <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                                @foreach($activeQuizzes as $quiz)
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="text-sm text-gray-500 dark:text-gray-400">{{ $quiz->course->title }}</div>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="text-sm text-gray-500 dark:text-gray-400">{{ $quiz->end_time->format('d M Y, H:i') }}</div>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="text-sm text-gray-500 dark:text-gray-400">{{ $quiz->duration_minutes }} menit</div>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                            <a href="{{ route('student.quizzes.show', $quiz) }}" class="text-amber-600 hover:text-amber-900 dark:text-amber-400 dark:hover:text-amber-300">Lihat</a>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
                ...
                @else
                    <p class="text-gray-600 dark:text-gray-400">Tidak ada kuis yang sedang aktif.</p>
                @endif
            </div>
        </div>
                            ...
                            <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                                @foreach($upcomingQuizzes as $quiz)
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="text-sm text-gray-500 dark:text-gray-400">{{ $quiz->start_time->format('d M Y, H:i') }}</div>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="text-sm text-gray-500 dark:text-gray-400">{{ $quiz->duration_minutes }} menit</div>
                                        </td>
        ...
        <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm rounded-lg">
            <div class="p-6">
                <h3 class="text-lg font-medium text-gray-900 dark:text-gray-100 mb-4">Kuis yang Telah Selesai</h3>
                            ...
                            <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                                @foreach($pastQuizzes as $quiz)
                                    ...
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            @if($attempt)
                                                <div class="text-sm text-gray-900 dark:text-white">{{ number_format($attempt->score, 2) }}</div>
                                            @else
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                            <a href="{{ route('student.quizzes.show', $quiz) }}" class="text-amber-600 hover:text-amber-900 dark:text-amber-400 dark:hover:text-amber-300">Lihat</a>
                                            @if($attempt)
                                                <a href="{{ route('student.quizzes.review', $attempt) }}" class="ml-2 text-blue-600 hover:text-blue-900 dark:text-blue-400 dark:hover:text-blue-300">Review</a>
                                            @endif
                                        </td>
                                    </tr>
                                @endforeach
                ...
                @else
                    <p class="text-gray-600 dark:text-gray-400">Tidak ada kuis yang telah selesai.</p>
                @endif
            </div>
        </div>
    </div>
